...
import { anthropicModels, type AnthropicModelId } from "../../../../src/shared/api"
...
const ChatView = ({ isHidden, showAnnouncement, hideAnnouncement, showHistoryView }: ChatViewProps) => {
	...
	const selectedModelInfo = selectedModelId ? anthropicModels[selectedModelId] : anthropicModels["claude-3-5-sonnet-20241022"]
